...
import qualified Bot.Telegram.HandleCallbackQuery
                                               as HCQ
import qualified Bot.Telegram.HandleMessage    as HM
import qualified Bot.Telegram.HandleMessage.Audio
                                               as HMAudio
import qualified Bot.Telegram.HandleMessage.Contact
                                               as HMContact
import qualified Bot.Telegram.HandleMessage.Document
                                               as HMDocument
import qualified Bot.Telegram.HandleMessage.Help
                                               as HMHelp
import qualified Bot.Telegram.HandleMessage.Location
                                               as HMLocation
import qualified Bot.Telegram.HandleMessage.Photo
                                               as HMPhoto
import qualified Bot.Telegram.HandleMessage.Poll
                                               as HMPoll
import qualified Bot.Telegram.HandleMessage.Repeat
                                               as HMRepeat
import qualified Bot.Telegram.HandleMessage.Sticker
                                               as HMSticker
import qualified Bot.Telegram.HandleMessage.Text
                                               as HMText
import qualified Bot.Telegram.HandleMessage.Venue
                                               as HMVenue
import qualified Bot.Telegram.HandleMessage.Video
                                               as HMVideo
import qualified Bot.Telegram.HandleMessage.VideoNote
                                               as HMVideoNote
import qualified Bot.Telegram.HandleMessage.Voice
                                               as HMVoice
import           Bot.Telegram.Updates           ( Update
                                                  ( callback_query
                                                  , message
                                                  , update_id
                                                  )
...
handleUpdates config hLogger countersRef ((callback_query -> Just cq) : us) =
  do
    counters    <- readIORef countersRef
